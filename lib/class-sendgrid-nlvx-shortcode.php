...
class SendGrid_NLVX_Shortcode {
    ...
    private function display_form() {
      ...
      $form_html .= '<form method="post" id="sendgrid_mc_email_form" class="mc_email_form" action="#sendgrid_mc_email_form">';
    ...
    private function display_form_small($title) {
      ...
      $form_html = '<form method="post" id="sendgrid_mc_email_form" class="newsletter-form" action="#sendgrid_mc_email_form">';
